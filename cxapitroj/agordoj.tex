...
%     \setmathfont[range=bb/{latin,Latin}]{TeX Gyre Termes Math}%
% }{}
% \IfFontExistsTF{STIX Two Math}{%
%     \setmathfont[range={"2218-"2218}]{STIX Two Math}
% }{}
...
% To define one's own proof environment,
% one has first to undefine the proof environment
% provided by "amsthm".
\let\proof\relax
\let\endproof\relax
\declaretheorem[%
...
\AtBeginDocument{%
    ...
    % % The following lines make \pi and \iota "roman"
    % % (instead of being "italic").
    % \let\umathpi\pi
...
\ifSubfilesClassLoaded{}{%
    \hypersetup{%
        ...
        pdflang = {zh-CN},
        pdfcreationdate = {D:20250513062831Z},
        pdfmoddate = {D:20250513062831Z},
        pdfproducer = {Amo},
