...
\IfFontExistsTF{LXGW WenKai Mono Light}{%
    \IfFontExistsTF{Sarasa Mono SC SemiBold}{%
        \IfFontExistsTF{Sarasa Mono SC Light Italic}{%
            \IfFontExistsTF{Sarasa Mono SC SemiBold Italic}{%
                \setCJKfamilyfont{lxgwwk}[
                    UprightFont = LXGW WenKai Mono Light,
                    BoldFont = * SemiBold,
                    ItalicFont = * Light Italic,
                    BoldItalicFont = * SemiBold Italic
                ]{Sarasa Mono SC}
                \renewcommand*{\regularscript}{\CJKfamily{lxgwwk}}
            }{}
        }{}
    }{}
}{
...
\providecommand{\iddots}{⋰}

% % These are commands for typesetting Stirling numbers.
...
\newcommand{\submat}[2]{\genfrac{\{}{\}}{0pt}{0}{#1}{#2}}
...
% A temporary fix for the incompatibility in
...
\declaretheorem[style=TheoremoidWithKai,name=定理,sibling=equation]{theorem}
\declaretheorem[style=TheoremoidWithKai,name=原理,sibling=theorem]{principle}
\declaretheorem[style=TheoremoidWithKai,name=假定,sibling=theorem]{assumption}
\declaretheorem[style=TheoremoidWithKai,name=定义,sibling=theorem]{definition}
\declaretheorem[style=TheoremoidWithKai,name=注,numbered=no]{remark*}
\declaretheorem[style=Theoremoid,name=例,sibling=theorem,qed=\diamond]{example}

% quod erat faciendum
\newcommand{\qefhere}{\qedhere}

% quod erat notandum
\newcommand{\qenhere}{\qedhere}
...
\newcommand{\nomodepruvo}{证}
\declaretheorem[style=Theoremoid,name=\protect\nomodepruvo,numbered=no,qed={证完.}]{pruvo}
...
% Commands for typesetting proper nouns: proper names and titles of books.
% They are in effect if it is in XeLaTeX (with redefinitions later).
...
\renewcommand{\propername}[1]{\CJKunderline-{#1}}
\renewcommand{\booktitle}[1]{\CJKunderwave-{#1}}
\else
\usepackage[normalem]{ulem}
\renewcommand{\propername}[1]{\uline{#1}}
\renewcommand{\booktitle}[1]{\uwave{#1}}
\fi
