...
\declaretheorem[style=TheoremStyle,name=定理,sibling=equation]{theorem}
\declaretheorem[style=TheoremStyle,name=原理,sibling=theorem]{principle}
\declaretheorem[style=TheoremStyle,name=假定,sibling=theorem]{assumption}
...
\declaretheorem[style=ProofStyle,name=\protect\nomodepruvo,numbered=no]{pruvo}
