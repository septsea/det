...
这是因为, 一般地, 计算行列式是复杂的事
(或许, 您还记得, % tex-fmt: skip
\(3\)~级阵的行列式的具体的公式含 \(6\)~项,
且 \(4\)~级阵的行列式的具体的公式含 \(24\)~项). % tex-fmt: skip
所以, 我们一般用别的方法
(如代入消元法、加减消元法)
解线性方程组.
