...
% latexmk -xelatex -file-line-error -interaction=nonstopmode -halt-on-error -silent -g testfonts
%
% If you prefer LuaLaTeX, you can also run:
% latexmk -lualatex -file-line-error -interaction=nonstopmode -halt-on-error -silent -g testfonts
%
